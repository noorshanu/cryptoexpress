...
function Whyus() {
  return (
    ...
    <div className="container-wrapper mx-auto">
      <div className="flex flex-col sm:flex-row justify-between gap-4 items-center ">
        <div>
          ...
          {goals.map((goal, index) => (
            <div key={index} className="goal-item max-w-[640px] text-base text-black flex items-center gap-4 py-4">
      ...
      >
        <SwiperSlide>
          <img src="images/slider1.jpg" className='h-[300px]  border rounded-lg p-2 bg-black' />
        </SwiperSlide>
        <SwiperSlide>
          <img src="images/slider2.jpg"  className='h-[300px] border rounded-lg p-2 bg-black'/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="images/slider3.jpg" className='h-[300px] border rounded-lg p-2 bg-black' />
        </SwiperSlide>
        <SwiperSlide>
          <img src="images/slider4.jpg" className='h-[300px] border rounded-lg p-2 bg-black' />
        </SwiperSlide>
      

      </Swiper>
          <h2 className=" text-center text-black text-2xl ml-12 font-medium">TAKE A LOOK INSIDE</h2>
        </div>
      </div>
    </div>
  </section>

      ...
      <div className=" container-wrapper">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 ">
            ...
            <div className=" flex items-center gap-4 text-white">
              <a
                ...
                target="_blank"
                className=" text-4xl hover:text-[#3da142]"
              >
                <FaTelegram />
              </a>
              <a
        ...
        <div className=" pr-0 sm:pr-16 mt-2 ">
          <h3 className=" text-white font-sohaReg text-base sm:text-start text-center">
            ...
            investment advice. Your investments are entirely your
            responsibility, and we disclaim any liability for potential losses
            resulting from adhering to or deviating from our opinions or
            content. Subscribing to follow the trades we offer is purely for
